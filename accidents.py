...
simulation = InsuredCustomers(30000, 10000, 0.001, claims_distribution)

[simulation.update(1) for i in range(10)]
claim_rates = simulation.monthly_claim_rate[simulation.monthly_claim_rate != 0]
...
anim = FuncAnimation(fig, anim, frames=1000, interval=10, repeat=False)
